...
# Coming Soon in 3.0
Beautiful gui that greets user with automatically scraped packages (apt, apk, pacman, docker, etc)
along with popularity, thumbnails, descriptions and a real-time search.
